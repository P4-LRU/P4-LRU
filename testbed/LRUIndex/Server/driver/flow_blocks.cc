...
struct rte_flow *generate_udp_flow(uint16_t port_id, uint16_t rx_q,
  ...
  memset(&eth_spec.dst, 0x00, ETHER_ADDR_LEN);
  memset(&eth_mask.dst, 0xff, ETHER_ADDR_LEN);
  memset(&eth_spec.src, 0x00, ETHER_ADDR_LEN);
  memset(&eth_mask.src, 0x00, ETHER_ADDR_LEN);
